  ...
  const handleNext = async () => {
    ...
    if (!state.sent) {
      ...
      const payload = {
        ...
        pharma: state.a.pharma || '', energia: state.a.energia || '', sonno: state.a.sonno || '', recupero: state.a.recupero || '',
        libido: state.a.libido || '', performance_sex: state.a.performance_sex || '',
        ciclo: state.a.ciclo || '', energia_ciclo: state.a.energia_ciclo || '',
        grasso: state.a.grasso || '', fame: state.a.fame || '', pressione: state.a.pressione || '', colesterolo: state.a.colesterolo || '',
