...
const s = {
  ...
  logoImg: { height: 36 },
  logoText: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 18, letterSpacing: 2, color: 'var(--text)' },
  desc: { fontSize: 13, color: 'var(--text-sec)', lineHeight: 1.6, maxWidth: 320 },
  heading: { fontFamily: "'Bebas Neue', sans-serif", fontSize: 14, letterSpacing: 3, color: 'var(--text-muted)', marginBottom: 16 },
